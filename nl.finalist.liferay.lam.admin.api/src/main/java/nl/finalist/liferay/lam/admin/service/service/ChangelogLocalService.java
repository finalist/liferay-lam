...
/**
 * Provides the local service interface for Changelog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChangelogLocalServiceUtil
...
public interface ChangelogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChangelogLocalServiceUtil} to access the changelog local service. Add custom service methods to {@link nl.finalist.liferay.lam.admin.service.service.impl.ChangelogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Changelog createChangelog(int installed_rank);
	...
	*/
	...
	public Changelog deleteChangelog(Changelog changelog);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Changelog deleteChangelog(int installed_rank)
	...
	*/
	...
	public Changelog fetchChangelog(int installed_rank);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Changelog getChangelog(int installed_rank) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Changelog> getChangelogs(int start, int end);
