...
class CreateFactoryBuilder extends FactoryBuilderSupport {
    ...
    CreateFactoryBuilder(CustomFields customFieldsService, Vocabulary vocabularyService, Site siteService, Category categoryService, UserGroups userGroupsService, RoleAndPermissions roleAndPermissionsService, WebContent webContentService) {
