...
class CreateOrUpdateFactoryBuilder extends FactoryBuilderSupport {
    ...
    CreateOrUpdateFactoryBuilder(Structure structureService, Template templateService, ADT adtService, WebContent webContentService, Document documentService, Bundle bundle){
