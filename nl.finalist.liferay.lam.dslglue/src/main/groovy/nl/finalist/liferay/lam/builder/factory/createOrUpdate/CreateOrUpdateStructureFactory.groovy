...
class CreateOrUpdateStructureFactory extends AbstractFactory {
    ...
    void onNodeCompleted(FactoryBuilderSupport builder, Object parent, Object node) {
        ...
        structureService.createOrUpdateStructure(model.structureKey, model.file, bundle, LocaleMapConverter.convert(model.nameMap), LocaleMapConverter.convert(model.descriptionMap), model.siteKey);
    }
}
