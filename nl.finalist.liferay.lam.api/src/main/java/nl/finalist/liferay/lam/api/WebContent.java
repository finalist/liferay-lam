...
public interface WebContent {
     ...
     */
	void addWebContent(Map<Locale, String> titleMap, Map<Locale, String> descriptionMap, String content, String urlTitle);
	/**
     * updates a webcontent to the Global group/site
     *
     * @param newTitle
     ...
     */
	void updateWebContent(Map<Locale, String> newTitle, Map<Locale, String> descriptionMap, String content, String urlTitle);
	/**
     * deletes a webcontent to the Global group/site
     *
     * @param urlTitle
