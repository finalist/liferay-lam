...
public class SiteImpl implements Site {
	...
	public void addSite(Map<Locale, String> nameMap, Map<Locale, String> descriptionMap, String friendlyURL) {
		try {
			groupService.addGroup(getDefaultUserId(), GroupConstants.DEFAULT_PARENT_GROUP_ID, Group.class.getName(), 0L, 
    ...
    @Override
	public void updateSite(String groupKey, Map<Locale, String> nameMap, Map<Locale, String> descriptionMap, String friendlyURL) {
		Group group;
		try {
			group = groupService.getGroup(PortalUtil.getDefaultCompanyId(), groupKey);
			groupService.updateGroup(group.getGroupId(), GroupConstants.DEFAULT_PARENT_GROUP_ID, nameMap, descriptionMap, GroupConstants.TYPE_SITE_OPEN, true, GroupConstants.DEFAULT_MEMBERSHIP_RESTRICTION, friendlyURL, true, true, null);
