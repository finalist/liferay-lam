    ...
    private void updateSiteInCompany(Boolean stagingEnabled, String webId, String groupKey, String friendlyURL, List<PageModel> pages,
        ...
        try {
            ...
            for (PageModel page : pages) {
                ...
                // pages for each locale, whereas it should just add a page for
                // the default locale
            ...
            if (group != null && stagingEnabled != null) {
                ...
                if (stagingEnabled) {
                    if (!group.hasStagingGroup()) {
                        stagingLocalService.enableLocalStaging(company.getDefaultUser().getUserId(), group, false, false, new ServiceContext());
