...
public class UserImplTest {
	...
	public void createUser_shouldAddUser() throws PortalException{
		user.createUser("tester", "tester@test.test", "Theo", "Tester", null, null, null, null);
		
		verify(userLocalService, times(1)).addUser(eq(USER_ID), eq(COMPANY_ID), eq(true), eq(null), eq(null), eq(false), 
				eq("tester"), eq("tester@test.test"), eq(0L), eq(null), eq(locale), eq("Theo"), eq(null),
				eq("Tester"), eq(0L), eq(0L), eq(true), eq(1), eq(1), eq(1970), eq(null), eq(null), eq(null), 
				eq(null), eq(null), eq(true), any(ServiceContext.class));
	}
	...
	public void createUser_shouldAddCustomFields_whenCustomFieldsHaveBeenSpecified() throws PortalException{
		...
		when(userLocalService.addUser(anyLong(), anyLong(), anyBoolean(), any(), any(), anyBoolean(), 
				anyString(), anyString(), anyLong(), any(), any(), anyString(), any(),
				anyString(), anyLong(), anyLong(), anyBoolean(), anyInt(), anyInt(), anyInt(), any(), any(), any(), 
				any(), any(), anyBoolean(), any())).thenReturn(mockUser);
		
		user.createUser("tester", "tester@test.test", "Theo", "Tester", null, null, null, customFields);
		
		verify(userLocalService, times(1)).addUser(anyLong(), anyLong(), anyBoolean(), any(), any(), anyBoolean(), 
				anyString(), anyString(), anyLong(), any(), any(), anyString(), any(),
				anyString(), anyLong(), anyLong(), anyBoolean(), anyInt(), anyInt(), anyInt(), any(), any(), any(), 
				any(), any(), anyBoolean(), any());
		verify(customFieldsService, times(1)).addCustomFieldValue(com.liferay.portal.kernel.model.User.class.getName(), "test", USER_ID, "test");
	}
	...
	public void updateUser_shouldOnlyUpdateUser_whenAllOtherFieldsAreEmpty() {
		...
		user.updateUser("tester", "tester2", "tester@test.test", "Theo", "Tester", null, null, null, null);
	...
	public void updateUser_shouldUpdateGroups_whenGroupsAreGiven() throws PortalException {
		...
		user.updateUser("tester", "tester2", "tester@test.test", "Theo", "Tester", null, groups , null, null);
	...
	public void updateUser_shouldUpdateRoles_whenRolesAreGiven() throws PortalException {
		...
		user.updateUser("tester", "tester2", "tester@test.test", "Theo", "Tester", roles, null, null, null);
	...
	public void updateUser_shouldUpdateUserGroups_whenUserGroupsAreGiven() throws PortalException {
		...
		user.updateUser("tester", "tester2", "tester@test.test", "Theo", "Tester", null, null, groups, null);
	...
	public void updateUser_shouldUpdateCustomFields_whenCustomFieldsAreGiven() throws PortalException {
		...
		Map<String, String> customFields = new HashMap<>();
		customFields.put("test", "test");
		user.updateUser("tester", "tester2", "tester@test.test", "Theo", "Tester", null, null, null, customFields);
		
		verify(userLocalService, times(1)).updateUser(any());
		verify(customFieldsService, times(1)).updateCustomFieldValue(com.liferay.portal.kernel.model.User.class.getName(), "test", USER_ID, "test");
	}
	...
	public void updateUser_shouldNotUpdateEmptyFields() throws PortalException {
		...
		user.updateUser("tester", null, null, null, null, null, null, null, null);
