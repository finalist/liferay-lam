...
public class CategoryImplTest {
    ...
    public void setUp() throws PortalException {
        ...
        /*
         * PowerMockito.when(PropsUtil.get("company.default.web.id")).thenReturn
         * ("liferay.com");
         * when(companyService.getCompanyByWebId("liferay.com")).thenReturn(
         * company);
         */
    ...
    public void testAddNewCategory() throws Exception {
        ...
        when(assetCategoryLocalService.addCategory(USER_ID, GLOBAL_GROUP_ID, "Style", 123L, mockServiceContext)).thenReturn(assetCategroy);
        Map<Locale, String> categoryNames = new HashMap<>();
        categoryNames.put(Locale.US, "StyleUS");
        categoryImpl.addCategory(new String[] {company.getWebId()}, categoryNames, "test", "testing it", "");
        // verify(assetCategoryLocalService).addCategory(USER_ID,
        // GLOBAL_GROUP_ID, categoryNames, 123L, mockServiceContext);
    }
    ...
    public void testUpdateCategory() throws PortalException {
        ...
        Map<Locale, String> categoryNames = new HashMap<>();
        categoryNames.put(Locale.US, "StyleUS");
        categoryImpl.updateCategory(new String[] {company.getWebId()}, "StyleUpdate", "vocabularyName", categoryNames);
    ...
    public void testNotUpdateCategory() throws PortalException {
        ...
        Map<Locale, String> categoryNames = new HashMap<>();
        categoryNames.put(Locale.US, "StyleUS");
        categoryImpl.updateCategory(new String[] {company.getWebId()}, "StyleNotUpdate", "vocabularyName", categoryNames);
    ...
    public void testNotDeleteCategory() throws PortalException {
        ...
        when(assetVocabulary.getCategories()).thenReturn(assetCategories);
        when(assetCategroy.getName()).thenReturn("StyleUpdate");
        categoryImpl.deleteCategory(new String[] {company.getWebId()}, "StyleDelete", "vocabularyName");
    ...
    public void testDeleteCategory() throws PortalException {
        ...
        when(assetVocabulary.getCategories()).thenReturn(assetCategories);
        when(assetCategroy.getName()).thenReturn("StyleUpdate");
        categoryImpl.deleteCategory(new String[] {company.getWebId()}, "StyleUpdate", "vocabularyName");
