...
public class CustomFieldsTest {
    ...
    public void testAddCustomTextField() throws PortalException {
        ...
        customFields.addCustomTextField(null, ENTITY_NAME, FIELD_NAME, "default", new String[] {RoleConstants.GUEST});
        ...
        verify(resourcePermissionService).setResourcePermissions(COMPANY_ID, ExpandoColumn.class.getName(), ResourceConstants.SCOPE_INDIVIDUAL,
                String.valueOf(mockColumn.getColumnId()), mockGuestRole.getRoleId(), new String[] {ActionKeys.VIEW, ActionKeys.UPDATE});
    }
    ...
    public void testAddCustomIntegerField() throws PortalException {
        ...
        customFields.addCustomIntegerField(null, ENTITY_NAME, FIELD_NAME, 1, new String[] {RoleConstants.GUEST});
    ...
    public void testDeleteCustomField() throws PortalException {
        ...
        customFields.deleteCustomField(null, ENTITY_NAME, FIELD_NAME);
    ...
    public void testAddCustomFieldValue() throws PortalException {
        customFields.addCustomFieldValue(null, ENTITY_NAME, FIELD_NAME, 0L, "content");
